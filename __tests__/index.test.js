...
test('gendiff', () => {
  ...
  const filePathTXT1 = getFixturePath('file1.txt');
  const filePathTXT2 = getFixturePath('file2.txt');
  ...
  expect(genDiff(filePathTXT1, filePathTXT2, 'plain')).toBe(expectedPlain);
});
